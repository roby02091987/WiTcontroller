...
#define CHOSEN_KEYPAD_0_DISPLAY_NAME     "0 F0/Luci"
#define CHOSEN_KEYPAD_1_DISPLAY_NAME     "1 F1"
#define CHOSEN_KEYPAD_2_DISPLAY_NAME     "2 F2"
#define CHOSEN_KEYPAD_3_DISPLAY_NAME     "3 F3"
#define CHOSEN_KEYPAD_4_DISPLAY_NAME     "4 F4"
#define CHOSEN_KEYPAD_5_DISPLAY_NAME     "5 F5"
#define CHOSEN_KEYPAD_6_DISPLAY_NAME     "6 F6"
...
#define BATTERY_CONVERSION_FACTOR 1.80
#define USE_BATTERY_PERCENT_AS_WELL_AS_ICON true
//#define USE_BATTERY_SLEEP_AT_PERCENT 15   // will put the device to sleep if the battery falls below this level
...
//
#define CUSTOM_APPNAME "Throttle 1"

// *********************************************************************************************************************
// Keypad hold time
// Time in ms after which the keypad key results in an "hold" state
